...
export const GET_RESTAURANTS_EVENTS_REQUEST = "GET_RESTAURANT_EVENTS_REQUEST";
export const GET_RESTAURANTS_EVENTS_SUCCESS = "GET_RESTAURANT_EVENTS_SUCCESS";
export const GET_RESTAURANTS_EVENTS_FAILURE = "GET_RESTAURANT_EVENTS_FAILURE";

export const CREATE_CATEGORY_REQUEST = "CREATE_CATEGORY_REQUEST";
export const CREATE_CATEGORY_SUCCESS = "CREATE_CATEGORY_SUCCESS";
export const CREATE_CATEGORY_FAILURE = "CREATE_CATEGORY_FAILURE";

export const GET_RESTAURANTS_CATEGORY_REQUEST = "GET_RESTAURANT_CATEGORY_REQUEST";
export const GET_RESTAURANTS_CATEGORY_SUCCESS = "GET_RESTAURANT_CATEGORY_SUCCESS";
export const GET_RESTAURANTS_CATEGORY_FAILURE = "GET_RESTAURANT_CATEGORY_FAILURE";
